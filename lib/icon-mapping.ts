/**
 * Icon SVG Mapping
 * Maps common icon names to inline SVG markup for accurate rendering
 */

// Common icons as inline SVG - viewBox 0 0 24 24
export const ICON_SVG_MAP: Record<string, string> = {
  ...
  'favorite': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/></svg>',
  ...
  // User / Account icons  
  'account': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>',
  ...
  'profile': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>',
  'person': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>',
  ...
  'hamburger': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="4" y1="18" x2="20" y2="18"/></svg>',
  ...
  'checkmark': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',
  
  // Share icon
  'share': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',
  
  // Compare icon
  'compare': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 3h5v5"/><path d="M8 3H3v5"/><path d="M21 3l-7 7"/><path d="M3 3l7 7"/><path d="M16 21h5v-5"/><path d="M8 21H3v-5"/><path d="M21 21l-7-7"/><path d="M3 21l7-7"/></svg>',
  
  // Star / rating icons
  'star': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',
  'star-filled': '<svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',
  ...
  'notification': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>',
...
/**
 * Common icon name patterns for matching
 */
const ICON_PATTERNS: Array<{ pattern: RegExp; iconKey: string }> = [
  // Search
  { pattern: /search|magnif/i, iconKey: 'search' },
  // Heart
  { pattern: /heart|favorite|like|wish/i, iconKey: 'heart' },
  // Cart/Shopping
  { pattern: /cart|shop|basket/i, iconKey: 'cart' },
  { pattern: /bag/i, iconKey: 'bag' },
  // User/Account
  { pattern: /user|account|profile|person/i, iconKey: 'account' },
  // Menu
  { pattern: /menu|hamburger|nav/i, iconKey: 'menu' },
  // Arrows
  { pattern: /arrow.*right|right.*arrow/i, iconKey: 'arrow-right' },
  { pattern: /arrow.*left|left.*arrow/i, iconKey: 'arrow-left' },
  { pattern: /chevron.*right|right.*chevron|next/i, iconKey: 'chevron-right' },
  { pattern: /chevron.*left|left.*chevron|prev|back/i, iconKey: 'chevron-left' },
  // Close
  { pattern: /close|dismiss|cancel/i, iconKey: 'close' },
  { pattern: /^x$/i, iconKey: 'x' },
  // Check
  { pattern: /check|tick|done|complete/i, iconKey: 'check' },
  // Share
  { pattern: /share/i, iconKey: 'share' },
  // Compare
  { pattern: /compare|versus/i, iconKey: 'compare' },
  // Star
  { pattern: /star|rating|rate/i, iconKey: 'star' },
  // Plus/Minus
  { pattern: /plus|add/i, iconKey: 'plus' },
  { pattern: /minus|subtract|remove/i, iconKey: 'minus' },
  // Email
  { pattern: /email|mail|envelope/i, iconKey: 'email' },
  // Phone
  { pattern: /phone|call|tel/i, iconKey: 'phone' },
  // Location
  { pattern: /location|map|pin|address/i, iconKey: 'location' },
  // Social
  { pattern: /facebook|fb/i, iconKey: 'facebook' },
  { pattern: /twitter|tweet/i, iconKey: 'twitter' },
  { pattern: /instagram|insta/i, iconKey: 'instagram' },
  { pattern: /linkedin/i, iconKey: 'linkedin' },
  // Trash
  { pattern: /trash|delete|remove/i, iconKey: 'trash' },
  // Edit
  { pattern: /edit|pencil|write/i, iconKey: 'edit' },
  // Filter
  { pattern: /filter|funnel/i, iconKey: 'filter' },
  // Settings
  { pattern: /setting|gear|cog|config/i, iconKey: 'settings' },
  // Eye
  { pattern: /eye|view|show|visible/i, iconKey: 'eye' },
  // Home
  { pattern: /home|house/i, iconKey: 'home' },
  // Download
  { pattern: /download/i, iconKey: 'download' },
  // Upload
  { pattern: /upload/i, iconKey: 'upload' },
  // Info
  { pattern: /info|about/i, iconKey: 'info' },
  // Alert
  { pattern: /alert|warn/i, iconKey: 'alert' },
  // Bell
  { pattern: /bell|notif/i, iconKey: 'bell' },
  // Calendar
  { pattern: /calendar|date/i, iconKey: 'calendar' },
  // Clock
  { pattern: /clock|time/i, iconKey: 'clock' },
];

/**
 * Get SVG properties for a node based on its name
 * @param nodeName The name of the Figma node (e.g., "akar-icons:search")
 * @returns The icon key and SVG string if found, null otherwise
 */
export function getIconFromName(nodeName: string): { key: string; svg: string } | null {
  const normalizedName = nodeName.toLowerCase();
  
  // First try exact match with icon name patterns (e.g., "akar-icons:search" -> "search")
  for (const { pattern, iconKey } of ICON_PATTERNS) {
    if (pattern.test(normalizedName)) {
      const svg = ICON_SVG_MAP[iconKey];
      if (svg) {
        return { key: iconKey, svg };
      }
    }
  }
  
  // Try direct key match
  if (ICON_SVG_MAP[normalizedName]) {
    return { key: normalizedName, svg: ICON_SVG_MAP[normalizedName] };
  }
...
/**
 * Generate an inline SVG element styled with specific dimensions and color
 * @param svgMarkup The raw SVG string
 * @param width Width in pixels
 * @param height Height in pixels
 * @param color Optional color (defaults to currentColor)
 * @returns Complete styled SVG markup
 */
export function createStyledSvg(
  svgMarkup: string, 
  width: number, 
  height: number, 
  color?: string
): string {
  // Add width, height, and optional color styling
  const styleAttr = color 
    ? `style="width: ${width}px; height: ${height}px; color: ${color};"` 
    : `style="width: ${width}px; height: ${height}px;"`;
  
  // Insert style attribute into the opening SVG tag
  return svgMarkup.replace('<svg ', `<svg ${styleAttr} `);
}
